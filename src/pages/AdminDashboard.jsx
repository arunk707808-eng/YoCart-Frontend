...
const AdminDashboard = () => {
  ...
  return (
    <div className='flex min-h-screen'>
      <div className={`${sidebarOpen?"translate-x-0":"-translate-x-full"} fixed lg:relative lg:translate-x-0 shadow-lg transition-transform duration-300 bg-background/50 border-b backdrop-blur z-40 `} >
      <div className="flex flex-col h-full p-4">
        <h1 className="text-lg font-bold mb-4">Admin Panel</h1>
         <div className="space-y-4">
          <Button variant='ghost' onClick={()=>setSelectedPage("home")}  className={`w-full flex items-center gap-2 ${
                selectedPage === "home" ? "bg-teal-100" : ""
              }`}>
          ...
          <Button
              ...
              className={`w-full flex items-center gap-2 ${
                selectedPage === "orders" ? "bg-teal-100" : ""
              }`}
            >
